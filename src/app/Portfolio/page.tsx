...
// Grid data for the 12-grid section
const gridItems = [
  {
    id: 1,
    title: "FA Beauty",
    image: "fabeauty.png",
    link: "https://www.fabeauty.in/"
  },
  {
    id: 2,
    title: "Siddhart Industries",
    image: "siddharthindustries.png",
    link: "https://siddharthindustries-chem.com/"
  },
  {
    id: 3,
    title: "Gajpati Couriers",
    image: "Gajpaticouriers.png",
    link: "https://gajpaticouriers.com/"
  },
  {
    id: 4,
    title: "Parashar Group of Hotel",
    image: "Parashargroup.png",
    link: "https://www.parashargroupofhotel.com/"
  },
  {
    id: 5,
    title: "Nyati Emerald",
    image: "Nyati Emerald.png",
    link: "https://nyatigroup.com/nyati-emerald/"
  },
  {
    id: 6,
    title: "MFHS Infra",
    image: "mfhsinfrs.png",
    link: "https://mfhsinfra.com/"
  },
  {
    id: 7,
    title: "Matrix Incorporation",
    image: "matrixinc.png",
    link: "https://matrixincorporation.com/"
  },
  {
    id: 8,
    title: "Air Online",
    image: "aironline.png",
    link: "https://www.aironline.in/"
  },
  {
    id: 9,
    title: "Max Healthcare",
    image: "maxhealthcare.png",
    link: "https://www.maxhealthcare.in/"
  },
  {
    id: 10,
    title: "Photon",
    image: "photonscan.png",
    link: "https://photonscanimaging.in/"
  },
  {
    id: 11,
    title: "Saudi Hotels",
    image: "saudihotel.png",
    link: "https://saudihotels.shop/"
  },
  {
    id: 12,
    title: "JPA Infra",
    image: "jpainfra.png",
    link: "https://www.jpinfra.com/index.php"
  }
];
...
const Portfolio = () => {
  ...
  return (
    <main className="min-h-screen bg-[#F5F7FA] text-[#2C3E50]">
      ...
      <div className="w-full h-auto md:h-12 bg-[#092A51] text-white py-2 md:py-0">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between px-4 py-2 md:py-0">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 w-full md:w-auto">
            <a href="tel:+919766313023" className="flex items-center gap-2 text-sm md:text-base">
              <FaPhoneAlt className="text-[#00CED1]" />
              +91 9766313023
            </a>
            <a href="mailto:info@aethermind.com" className="flex items-center gap-2 text-sm md:text-base">
      ...
      <section className="relative w-full h-60 md:h-80 overflow-hidden">
        <Image
          src="port.jpg" // Changed to a portfolio-related image
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our diverse range of projects across various industries. Each project represents our commitment to excellence and innovation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {gridItems.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-semibold text-[#092A51] mb-2 group-hover:text-blue-600 transition-colors duration-300">
                    {item.title}
                  </h3>
