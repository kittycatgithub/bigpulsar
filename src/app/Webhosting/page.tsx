          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-gray-700">
                <li><strong>🌐 Shared & Dedicated Hosting</strong> – Choose the right plan for your growth stage.</li>
                <li><strong>⚡ High-Speed Performance</strong> – Optimized servers for faster page loads and smooth experience.</li>
                <li><strong>🔒 Security & Backups</strong> – Daily backups, SSL certificates, and DDoS protection.</li>
                <li><strong>📈 Scalability</strong> – Seamless upgrades as your business grows.</li>
                <li><strong>🛠 24/7 Support</strong> – Expert support team available whenever you need help.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-gray-700">
                <li>✔ 99.9% Uptime Guarantee for uninterrupted services.</li>
                <li>✔ Scalable resources that grow with your business needs.</li>
                <li>✔ Secure servers with SSL, firewalls, and malware protection.</li>
                <li>✔ Cost-efficient plans without compromising quality.</li>
                <li>✔ Global data centers ensuring fast load times worldwide.</li>
              </ul>
            </div>
